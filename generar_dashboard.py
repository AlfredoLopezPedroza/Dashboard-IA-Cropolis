...
:root {{
  ...
  --text:#dbe6f0; --text-dim:#94a7bd; --text-bright:#f4f8fc;
...
.header p {{ color: var(--text); font-size: 14.5px; margin: 4px 0; max-width: 760px; }}
...
.resumen {{ margin: 0 0 12px; padding-left: 18px; font-size: 14.5px; line-height:1.55; color: var(--text); }}
.resumen li {{ margin-bottom: 6px; }}
.nota {{ font-size: 13.5px; color: var(--text-dim); font-style: italic; }}
.tarjeta-footer {{ display:flex; flex-wrap:wrap; gap:8px; padding-top:12px; border-top:1px solid var(--border); margin-top: 10px; }}
.meta {{ font-family: var(--font-mono); font-size: 11.5px; font-weight:600; color: var(--text); background: rgba(255,255,255,.05); padding:4px 8px; border-radius:6px; }}
table {{ width:100%; border-collapse: collapse; margin-top: 18px; font-size: 14.5px; background: var(--bg-card); border-radius: 12px; overflow: hidden; border: 1px solid var(--border); }}
th {{ background: rgba(0,180,255,.08); color: var(--cyan); text-align:left; padding: 11px 14px; font-family: var(--font-mono); font-size: 11.5px; text-transform: uppercase; letter-spacing: .06em; border-bottom:1px solid var(--border); }}
td {{ padding: 11px 14px; border-bottom: 1px solid rgba(255,255,255,.04); color: var(--text); }}
